...
//Recycled skeleton taken from Year 1 Summative 14: OOConsoleMenu
namespace PS_Application
{
    ...
    class MainMenu : ConsoleMenu //The main menu 
    {
        ...
        {
            _menuItems.Clear();
            _menuItems.Add(new AddNewProjectMenu(_projectManager));
            _menuItems.Add(new LoadFileMenu(_projectManager));
            _menuItems.Add(new ViewExistingProjectsMenu(_projectManager));
